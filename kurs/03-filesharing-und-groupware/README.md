# Termin 3: Nextcloud – Filesharing & Groupware selbst hosten
 
## Inhalte
 
1. [Was ist Nextcloud?](01-nextcloud.md): Überblick
2. [Nextcloud AIO Setup](02-nextcloud-aio-setup.md): Installation mit dem All-in-One Docker Image
...
`digital_independence_session_3.pdf`
 
## Voraussetzungen für diese Einheit
 
- Ubuntu Server VM aus Termin 2 läuft und ist per SSH erreichbar
- Docker und Docker Compose sind installiert
- Mindestens **4 GB RAM** und **40 GB freier Speicher** für die VM (AIO braucht mehr als Excalidraw)
